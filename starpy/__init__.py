"""asyncio Protocols for Communication with the Asterisk PBX
...
want to allow for multi-protocol communication using
asyncio.  Their integration with Asterisk does not require any
